...
class Assistant:
    ...
    def __init__(self):       #конструктор
        ...
        self.cmds = {   # список функций и команд, при которых они выполняются
            ...
            ('запомни', 'запомни и напомни попозже'): self.save_reminder,
            ...
            ('номер телефона', 'список контактов'): self.contacts_reminder,
        }
        ...
        self.commands = [
            ...
            'запомни', 'запомни и напомни попозже',
            ...
            'номер телефона', 'список контактов',
        ]
